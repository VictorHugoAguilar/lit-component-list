...
import { uuid } from "./mixin/utils/uuid";

import { FormControlMixin } from "./mixin/FormControlMixin";
import { ScopedElementsMixin } from "./mixin/ScopedElementsMixin";
import { ChoiceGroupMixin } from "./mixin/ChoiceGroupMixin";
import { SlotMixin } from "./mixin/SlotMixin";
import { FormRegistrarMixin } from "./mixin/FormRegistrarMixin";
...
const ListboxMixinImplementation = (superclass) =>
    ...
    class VhaaListbox extends FormControlMixin(
        ...
        static get scopedElements() {
            const dataScopedElements = {
                // @ts-expect-error [external] fix types scopedElements
                ...super.scopedElements,
                "vhaa-options": VhaaOptions,
            };
            // console.log("scopedElements", dataScopedElements);
            return dataScopedElements;
        }
        ...
        get slots() {
            const dataSlots = {
                ...
                input: () => {
                    ...
                    // console.log("vhaaOptions", vhaaOptions.registrationTarget);
                    return vhaaOptions;
                },
            };
            // console.log("dataSlot ", dataSlots);
            return dataSlots;
        }
        ...
        get _listboxActiveDescendantNode() {
            return /** @type {HTMLElement} */ (this._listboxNode.querySelector(`#${this._listboxActiveDescendant}`));
        }
